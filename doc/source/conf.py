...
# -*- coding: utf-8 -*-
#
# montypy.grail documentation build configuration file, created by
...
try:
    fullversion = version("montypy.grail")
except Exception:
...
modindex_common_prefix = ["montypy.grail"]
...
basename = "montypy.grail".replace(" ", "").replace(".", "")
